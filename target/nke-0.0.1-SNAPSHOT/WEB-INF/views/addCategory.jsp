...
{
	var title = document.forms["AddCategory"]["title"]
...
<section class="container">
	<p>${success}</p>
	<p><a href="${pageContext.request.contextPath}/admin/category?page=1"><button type="button" class="btn btn-dark">Back to Categories</button></a></p>
	<form:form method="POST" modelAttribute="newCategory" class="form-horizontal" enctype="multipart/form-data" name="AddCategory" onsubmit="return ValidationCheck()">
		<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="categoryImage">Image Upload</label>
					<div class="col-lg-10">
