...
<section class="container">
	...
	<div class="col-sm-12 col-md-12 col-lg-6" style="margin-top: 10px; padding-bottom: 10px">
				...
				<img src= ${ category.photoUrl}  alt="Category Photo" width="100%" height="100%">
			</div>
			
 <div class="col-sm-12 col-md-12 col-lg-4" style="margin-top: 10px; padding-bottom: 10px; padding-top: 25px">
	<form:form method="POST" modelAttribute="category" class="form-horizontal" enctype="multipart/form-data">
		<fieldset>
				<div class="form-group">
				<form:input type="hidden" id="categoryId" path="categoryId" class="form-control" value="${category.categoryId}" />
				</div>
				<div class="form-group">
				<form:input type="hidden" id="photoVersion" path="photoVersion" class="form-control" value="${category.photoVersion}" />
				</div>
				<div class="form-group">
				<form:input type="hidden" id="photoId" path="photoId" class="form-control" value="${category.photoId}" />
				</div>
				<div class="form-group">
				<form:input type="hidden" id="publicId" path="publicId" class="form-control" value="${category.publicId}" />
				</div>
				<div class="form-group">
					<label for="title">Category Title</label>
						<form:input id="title" path="title" type="text" class="form-control" placeholder="${category.title }" />
				</div>
				
				<div class="form-group">
					<label class="control-label col-lg-2" for="categoryImage">Upload New Image?</label>
					<div class="col-lg-10">
					<form:input id="categoryImage" path="categoryImage" type="file" class="form:input-large" />
					</div>
				</div>

			<div class="form-group">
				<div class="col-lg-offset-2 col-lg-10">
				<input type="submit" id="btnAdd" class="btn btn-primary" value ="Update" onclick="return confirm('Are you sure you want to update this category?')"/>
				</div>
				<br>
				<p><a href="${pageContext.request.contextPath}/admin/category/manage?id=${category.categoryId }&page=${pagenumber}"><button type="button" class="btn btn-dark">Back to Category</button></a></p>
			</div>
		</fieldset>
	</form:form>
	</div>
