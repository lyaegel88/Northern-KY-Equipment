 ...
 <div class="col-sm-12 col-md-12 col-lg-4" style="margin-top: 10px; padding-bottom: 10px; padding-top: 25px">
	<form:form method="POST" modelAttribute="user" class="form-horizontal" enctype="multipart/form-data">
		<fieldset>
				...
				<form:input type="hidden" id="userId" path="userId" class="form-control" value="${user.userId}" />
				</div>
				<div class="form-group">
				<form:input type="hidden" id="username" path="username" class="form-control" value="${user.username}" />
				</div>
				<div class="form-group">
					<label for="emailAddress">Email</label>
						<form:input id="emailAddress" path="emailAddress" type="text" class="form-control" placeholder="${user.emailAddress }" />
				</div>
				<div class="form-group">
					<label for="currentPassword">Enter Password to Update</label>
						<form:input id="currentPassword" path="currentPassword" type="password" class="form-control" />
				</div>

			<div class="form-group">
				<div class="col-lg-offset-2 col-lg-10">
				<input type="submit" id="btnAdd" class="btn btn-primary" value ="Save Email" onclick="return confirm('Are you sure you want to update this user?')"/>
				</div>
				<br>
